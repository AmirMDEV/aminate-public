...
- Dynamic Parenting keeps a visible `History` list in the `More` section, and you can jump to a switch, delete one saved switch, or clear all saved switches for that object.
