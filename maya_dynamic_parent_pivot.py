    ...
    class MayaAnimWorkflowWindow(_ContentBase):
        ...
        def _build_guide_tab(self):
            ...
            guide.setPlainText(
                ...
                "- Pick the thing it should follow and click Pick Parent.\n"
                "- Click Snap To Parent first if you want it to jump onto that parent.\n"
                "- Or move it by hand, leave Maintain Current Offset on, and click Switch to keep that exact spot.\n"
                "- Click World if it should stop following everything.\n"
                "- Example: when the magazine is in the gun, use Maintain Current Offset to keep it exactly where it is, then switch it to the gun. Or click Snap To Parent first if you want it to jump onto the gun before switching.\n"
