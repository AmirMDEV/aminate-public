    ...
    class MayaAnimWorkflowWindow(_ContentBase):
        ...
        def _build_guide_tab(self):
            ...
            guide.setPlainText(
                ...
                "- Click Switch to make it follow that thing on the next frame.\n"
                "- Click World if it should stop following everything.\n"
                "- Leave Stay Put on if it should not jump.\n"
                "- Example: when the magazine is in the gun, make it follow the gun. When a hand pulls it out, make it follow the hand. When you let go, make it follow World.\n"
