    ...
    class MayaAnimWorkflowWindow(_ContentBase):
        ...
        def _build_guide_tab(self):
            ...
            guide.setPlainText(
                ...
                "- Pick the moving thing, like a magazine control, and click Add Constrained Object.\n"
                "- Pick the hand, gun, or other object it should follow and click Use Picked Parent.\n"
                "- Click Switch To Picked Parent if you want the current frame to keep the old parent and the next frame to turn the new parent on.\n"
                "- Click Add Picked Parent Choice if you want to keep that parent as a saved option for later.\n"
                "- Leave Keep Current Position When It Switches on if it should stay where it is when the new parent turns on.\n"
                "- Click Switch To Picked Row when you want the chosen parent row to turn on next frame.\n"
                "- Click Switch To World when it should stop following everything on the next frame.\n"
                "- Change the Weight values and click Key Shown Blend (Advanced) only when you want a real blend, like half world and half gun.\n"
                "- Use Fix Pop On This Frame if you change parents and want the current frame to stay locked cleanly.\n"
