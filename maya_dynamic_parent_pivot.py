    ...
    class MayaAnimWorkflowWindow(_ContentBase):
        ...
        def _build_guide_tab(self):
            ...
            guide.setPlainText(
                ...
                "- Pick the moving thing, like a magazine control, and click Add Object.\n"
                "- Pick the hand, gun, or other object it should follow and click Pick Parent.\n"
                "- Click Switch if you want the current frame to keep the old parent and the next frame to turn the new parent on.\n"
                "- Leave Stay Put on if it should stay where it is when the new parent turns on.\n"
                "- Click Switch Chosen when you want the chosen row to turn on next frame.\n"
                "- Click World when it should stop following everything on the next frame.\n"
                "- Open More only when you want saved parent choices, blends, or history.\n\n"
                "Hand / Foot Hold\n"
